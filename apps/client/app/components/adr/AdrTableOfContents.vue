...
<template>
  <nav class="sticky top-24 space-y-1 text-right">
    <div class="flex items-center justify-start gap-2 mb-3 px-3">
    ...
    <a
      ...
      :key="section.id"
      :href="`#${section.id}`"
      class="flex items-center justify-start gap-2 px-3 py-1.5 rounded-lg text-base transition-colors duration-200"
